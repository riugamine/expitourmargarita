...
export default function FeaturedDestinations() {
  ...
  return (
    <section className="py-16 bg-white dark:bg-expitour-blue/20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="font-poppins text-3xl md:text-4xl font-bold text-expitour-dark dark:text-white mb-4">
            Destinos Destacados
          </h2>
          <p className="font-lora text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          {destinations.map((destination, index) => (
            <div key={index} className="group relative overflow-hidden rounded-lg shadow-md">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                ...
                <p className="font-lora text-sm mb-3 opacity-90">{destination.description}</p>
                <Link href={destination.link} className="inline-flex items-center text-sm font-poppins text-expitour-yellow hover:text-expitour-amber transition-colors duration-300">
                  Explorar
